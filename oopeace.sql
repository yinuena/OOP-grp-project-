...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 28, 2023 at 08:28 AM
...
--
ALTER TABLE `income_expense`
  ADD CONSTRAINT `FOREIGN KEY` FOREIGN KEY (`username`) REFERENCES `users` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
